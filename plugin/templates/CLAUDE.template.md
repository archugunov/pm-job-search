...
| Tailor your master CV for a specific role | `/apply <Company>` |
...
- `not_interested` — you passed on it (changed mind, listing expired, withdrew at any stage, no longer relevant). Reachable from any active stage including `new`.
