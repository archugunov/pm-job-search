...
1. **Fenced code blocks used as chat summaries.** Triple-backtick blocks rendering a summary to the user (rendered, not stored on disk). Convert to blockquote (`>` lines) or plain prose.
