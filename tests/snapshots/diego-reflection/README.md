...
- Calendar-event reference — Retool's `next_event: "Panel round Tue 2026-07-14 16:00"` is 1 day out from today; would surface in Heads-up if calendar were wired (it isn't in this install).
...
- **Trigger A** (cadence drift, >50% application miss for 3 weeks running) — **fires as shipped.** Application windows ending 2026-07-13: 1/3 (miss), 0/3 (miss), 0/3 (miss). All three under 50% of target.
- **Trigger C condition 2** (3+ rejections at the same stage) — **fires as shipped.** Three rejections all at `take-home`: Fly.io 2026-06-03, Render 2026-06-13, Railway 2026-06-24. Highest-severity (C suppresses A's bullet when both fire).
...
- `journal.md` — 4 weeks of dated entries (2026-05-13 → 2026-07-11) + 2 weekly reflection blocks.
