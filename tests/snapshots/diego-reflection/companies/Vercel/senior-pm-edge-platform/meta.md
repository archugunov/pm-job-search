...
Frontend cloud + edge compute platform. ~400 ppl globally, but Edge Platform team is ~25. Strong dev-tools-PLG fit; founder-influenced product still. Edge Platform PM owns the runtime + DX for dev-side edge functions.
